package com.ideamatic.micro.accounts;
...
@Configuration
@ComponentScan
@EntityScan("com.ideamatic.micro.accounts")
@EnableJpaRepositories("com.ideamatic.micro.accounts")
...
public class AccountsConfiguration {
    ...
    public DataSource dataSource() {
        ...
        // accounts.
        DataSource dataSource = (new EmbeddedDatabaseBuilder()).addScript("classpath:testdb/schema.sql").addScript("classpath:testdb/data.sql").build();
